            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h1 class="box-title" ><B>potentialcustomer</B></h1>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal"  id="editForm" action="<%=path%>/com/update" method="post">
                                        ...
                                        <div class="form-group">
                                            <span class="col-sm-4 control-label">公司名</span>
                                            <div class="col-sm-6">
                                                <input id="Company" name="Company" class="form-control" type="text" placeholder="公司名">
                                            </div>
                                        </div>
