...
@section("content")
    ...
    <section class="content">
                <form class="form-horizontal"  id="editForm" action="/admin/accounts/updt/{{$read->id}}}" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-xs-3">
                            <select id="select"  name="Account_Type"  style="width: 260px; height: 30px; overflow-y:auto" >
                                <option value="{{$read->Account_Type}}">请选择</option>
                    ...
                    <div class="form-group">
                        <div class="col-sm-8 col-sm-offset-5">
                            ...
                            <a href="/admin/account"><span class="btn btn-default btn-small" data-dismiss="modal" style="margin-left:10px;">取消</span></a>
                        </div>
                    </div>
                </form>
    </section>
